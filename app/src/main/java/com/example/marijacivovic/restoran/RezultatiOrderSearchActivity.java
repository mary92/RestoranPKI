...
public class RezultatiOrderSearchActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_moj_nalog:
                Intent intent = new Intent(RezultatiOrderSearchActivity.this, MojNalogActivity.class);
    ...
    public class MyUserSearchAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                LayoutInflater inf = LayoutInflater.from(RezultatiOrderSearchActivity.this);
